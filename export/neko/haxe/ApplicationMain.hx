...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "ilem", "com.example.myapp", "0.0.1");
		...
		flash.Lib.create (function () {
				...
				openfl.Assets.loadLibrary ("default", function (_) {});
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ilem", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function init ():Void {
		...
		total++;
		openfl.Assets.loadLibrary ("default").onComplete (library_onLoad);
